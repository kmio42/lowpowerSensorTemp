...
/**
 ...
 \return none
 */
extern void lcd_write_i2c(unsigned char value);		//-	Write data to i2c
...
/**
 ...
 \return none
 */
extern void lcd_write(unsigned char value);			//-	Write byte to display with toggle of enable-bit
 ...
 */
extern bool lcd_gotolr(unsigned char line, unsigned char row);	//-	Go to position
...
/**
 ...
 \return none
 */
extern void lcd_putchar(unsigned char value);			//-	Put char to cursor position
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_putcharlr(unsigned char line, unsigned char row, unsigned char value);	//-	Put char to position
...
/**
 ...
 \return none
 */
extern void lcd_print(unsigned char *string);			//-	Print string to cursor position
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_printlr(unsigned char line, unsigned char row , unsigned char *string);	//-	Print string to position
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_printlc(unsigned char line, unsigned char row, unsigned char *string);		//-	Print string to position
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_printlrc(unsigned char line, unsigned char row, unsigned char *string);	//-	Print string to position
											//-	(If string is longer than LCD_ROWS
...
/**
 ...
 \return none
 */
extern void lcd_command(unsigned char command);		//-	Issue a command to the display (use the defined commands above)
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_nextline(void);				//-	Go to nextline (if next line > LCD_LINES return false)

/**
 \brief Read data from i2c (for internal use)
 \retval "unsigned char" byte received over i2c
 */
extern unsigned char lcd_read_i2c(void);			//-	Read data from i2c
 ...
 */
extern unsigned char lcd_read(bool mode);			//-	Read data from display over i2c
 ...
 */
extern unsigned char lcd_getbyte(bool mode);			//-	Read one complete byte over i2c from display
...
/**
 ...
 \retval false if not successfull
 */
extern bool lcd_getlr(unsigned char *line, unsigned char*row);	//-	Get line and row (target byte for line, target byte for row)
 ...
 */
extern bool lcd_busy(void);					//-	Check if busy
...
/**
 ...
 \return none
 */
extern void lcd_wait_us(unsigned short us);			//-	Wait some microseconds
...
/**
 ...
 \return none
 */
extern void lcd_wait_ms(unsigned short ms);			//-	Wait some milliseconds
