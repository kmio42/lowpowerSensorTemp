...
void nrf24_config(uint8_t channel, uint8_t pay_length)
{
    ...
    nrf24_configRegister(SETUP_RETR,(0x01<<ARD)|(0x0A<<ARC));
...
void nrf24_powerUp() {
	nrf24_ce_digitalWrite(LOW);
	nrf24_configRegister(CONFIG, (1 << PWR_UP) | nrf24_CONFIG);
}

//void nrf24_setTxPower(uint8_t pwr) {
//	nrf24_configRegister(RF_SETUP,)
//}
